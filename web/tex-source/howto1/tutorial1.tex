...
5
6 control.shf peersim.cdsim.Shuffle
7
8 network.size 50000
9  
10 protocol.lnk peersim.core.IdleProtocol
11
12 protocol.avg example.aggregation.AverageFunction
13 protocol.avg.linkable lnk
14 
15 init.rnd peersim.dynamics.WireKOut
...
22
23 init.lin peersim.vector.LinearDistribution
...
\footnotesize
\begin{verbatim}
<protocol | init| control> . string_id   full_path_classname
\end{verbatim}
\normalsize

and its parameters (if any) follows this scheme:
...
6
7 control.shf peersim.cdsim.Shuffle
8
...
16
17 init.rnd peersim.dynamics.WireKOut
...
24
25 init.ld peersim.vector.LinearDistribution
...
35
36 control.dnet peersim.dynamics.DynamicNetwork
