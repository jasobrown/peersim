 ...
 * @config
 */
static final String PAR_METHOD = "setter";
...
* Sets the given integer value.
*/
void set(int i, long val) { set(Network.get(i),val); }
...
* Sets the given real value.
*/
void set(int i, double val) { set(Network.get(i),val); }
