...
/**
 * It test the network for sensiticity for random node removal. Of course it
 * does not actually remove nodes, it is only an observer.
 */
 ...
 * effect the overlay will be shuffled. Defaults to 1.
 * @config
 */
