...
/**
 * The number of nodes to add when nodes are scheduled for addition. This can be
 * negative which results in the deletion of that many nodes. It can also be
 * non-integer if {@value #PAR_PERC} is set.
 * @config
 */
 ...
 * of a constant value. Default is constant value (ie that this parameter is not
 * present).
 * @config
 */
private static final String PAR_PERC = "percentage";

/**
 * The network is grown until reaching this number of nodes. The network will
 * never exceed this size as a result of this network manager. Defaults to
 * {@link Network#getCapacity()}.
 * @config
 */
private static final String PAR_MAX = "maxsize";

/**
 * The network is cut until reaching this number of nodes. The network will
 * never go below this size as a result of this network manager. Defaults to 0.
 * @config
 */
...
{
	if (add == 0 || (maxsize <= Network.size() && add > 0)
