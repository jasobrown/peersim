...
public class RobustnessEvaluator {
    class NodesPair {
        ...
        public boolean equals(Object o){
            if (!(o instanceof NodesPair)) return false;
            else {
    ...
    private Set initPairs(Graph g){
        HashSet pairs = new HashSet(pairsNo);
    ...
    /**
     * @return Numero medio di nodi che devono fallire prima che una generica
     * coppia connessa presa a caso nel grafo non sia piu connessa.
     */
    public float getMetric1(){
        return avg;
    }
    /**
     * @return Un array contentente il numero di componenti non piu' connesse
     * all'aumentare dei nodi guasti
     */
