...
\end{verbatim}
%\texttt{\footnotesize \$> java -cp <class-path> peersim.Simulator
%config-file.txt}\\
...
Linkable linkable = (Linkable)node.getProtocol(linkableID);
\end{verbatim}
%\texttt{\footnotesize int linkableID = FastConfig.getLinkable(protocolID);\\
%Linkable linkable = (Linkable)node.getProtocol(linkableID);
%}~\\
%{\footnotesize \par}
...
BasicBalance n = (BasicBalance)peer.getProtocol(protocolID);
\end{verbatim}
%texttt{\footnotesize BasicBalance n = (BasicBalance)peer.getProtocol(protocolID);}
